...
image::http://www.opensourcecitizen.org/badge?url=github.com/jforge/docker-nodejs-unresponsive-app[link=http://www.opensourcecitizen.org/project?url=github.com/jforge/docker-nodejs-unresponsive-app]
